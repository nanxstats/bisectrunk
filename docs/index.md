...
`bisectrunk` finds the commit that changed a result. It searches for behavior
changes in a Git repository while owning the repetitive work around each
candidate: isolated checkout, installation, execution, classification,
